...
message(STATUS "client_server: 0 messages, 1 services")
...
get_filename_component(_filename "/home/fares/Desktop/catkin_ws/src/client_server/srv/mult.srv" NAME_WE)
add_custom_target(_client_server_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "client_server" "/home/fares/Desktop/catkin_ws/src/client_server/srv/mult.srv" ""
)
...
_generate_srv_cpp(client_server
  "/home/fares/Desktop/catkin_ws/src/client_server/srv/mult.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/client_server)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/client_server\")")
  # install generated code
  install(
